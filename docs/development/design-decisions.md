...
| | |
|---|---|
| **Chosen** | Initial reward of 10^12 μNXS per epoch, discrete halving every 100,000 epochs, tail emission floor at 0.1% of circulating supply annualized |
