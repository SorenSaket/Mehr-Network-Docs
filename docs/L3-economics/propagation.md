...
When a post earns more in [kickback](/docs/L5-services/mhr-store#revenue-sharing-kickback) than it costs to store, it becomes **self-sustaining**:
...
Interest relay nodes earn relay fees for bridging communities. They subscribe to a topic via [MHR-Pub Scope subscriptions](/docs/L5-services/mhr-pub#interest-feeds) and forward content to other interested nodes.
